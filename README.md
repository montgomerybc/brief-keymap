...
|`Numpad` _number_         |:new_moon:            |Set mark _number_                 |                                                          |
|`Ctrl` + `Numpad` _number_|:new_moon:            |Go to mark _number_               |                                                          |
...
|`Shift` + `F7`            |:new_moon:            |Pause Macro                       |?? Epsilon: http://www.lugaru.com/man/Brief.Emulation.html|
